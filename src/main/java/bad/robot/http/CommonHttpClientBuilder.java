 ...
 * {@link HttpClient} calls. For example, you might set a timeout using the {@link CommonHttpClientBuilder#with(com.google.code.tempusfugit.temporal.Duration)}
 ...
 *
 */
public interface CommonHttpClientBuilder extends HttpClient {

    CommonHttpClientBuilder with(Duration timeout);

    CommonHttpClientBuilder with(String username, String password);
